...
from app.api.routers.blocking_reasons import router as blocking_reasons_router, router_alias as blocking_reasons_alias_router
...
main_router.include_router(blocking_reasons_alias_router)
